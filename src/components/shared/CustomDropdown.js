...
OptionsMenu.defaultProps = {
	...
	handleSelectionByKey: PropTypes.func.isRequired, // used for selecting options w/ "Enter" and nav via "Tab"
	handleFocus: PropTypes.func.isRequired, // "onFocus" handler for options' item navigation
	hasFocus: PropTypes.string.isRequired, // handles currently focused item
